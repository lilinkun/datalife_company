 ...
 */
@Entity
public class MeasureFamilyUserInfo implements Serializable {
    ...
    @Generated(hash = 914786124)
    public MeasureFamilyUserInfo() {
    }

    @Generated(hash = 887831134)
    public MeasureFamilyUserInfo(int Member_Id, int user_id, String user_name, String Member_Sex, String Member_Name, String Member_Portrait, double Member_Stature, double Member_Weight, String Member_DateOfBirth, int Member_Status, boolean Member_IsDefault, String CreateDate, String Member_Phone, String Member_Province, String Member_City, String Member_District, int isIdataRegister, String isIdataRegister_Name, String AddressName) {
