...
import com.datalife.datalife_company.BuildConfig;
import com.datalife.datalife_company.R;
import com.datalife.datalife_company.util.IDatalifeConstant;

/**
 * 带有刻度的圆形进度条
 * Created by liguo on 2018/5/8.
 */
...
public class DialProgress extends View {
    ...
    //刻度线没选中的颜色
    private Paint mDialPaint1;
    private int mDialColor1;
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mValueColor = typedArray.getColor(R.styleable.DialProgress_valueColor, Color.WHITE);
        ...
        mBgArcColor = typedArray.getColor(R.styleable.DialProgress_bgArcColor, Color.TRANSPARENT);
        ...
        mDialColor1 = typedArray.getColor(R.styleable.DialProgress_dialColor1, Color.GRAY);
    ...
    private void initPaint() {
        ...
        mDialPaint1 = new Paint();
        mDialPaint1.setAntiAlias(antiAlias);
        mDialPaint1.setColor(mDialColor1);
        mDialPaint1.setStrokeWidth(mDialWidth);
    }
    ...
    private void drawDial(Canvas canvas) {
        ...
        for (int i = 0; i <= total-rest-1; i++) {
            canvas.drawLine(mCenterPoint.x + mRadius, mCenterPoint.y, mCenterPoint.x + mRadius + mArcWidth, mCenterPoint.y, mDialPaint1);
            canvas.rotate(mDialIntervalDegree, mCenterPoint.x, mCenterPoint.y);
        }
        canvas.restore();
    }
    ...
    private void drawText(Canvas canvas) {
        if (mValue <= 0){
//            canvas.drawText("--", mCenterPoint.x, mValueOffset-20, mValuePaint);
            mValue = -4;
        }else {
//            canvas.drawText(String.valueOf(mValue), mCenterPoint.x, mValueOffset-20, mValuePaint);
//            canvas.drawText(String.format(mPrecisionFormat, mValue), mCenterPoint.x, mValueOffset-20, mValuePaint);
        }
