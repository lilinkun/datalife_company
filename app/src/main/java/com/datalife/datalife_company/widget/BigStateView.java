...
public class BigStateView extends View {
    ...
    ;
    private String unit = "";
    private String text_1 = getResources().getString(R.string.text_Low_text), text_2 = getResources().getString(R.string.text_Standard_text), text_3 = getResources().getString(R.string.text_High_text);
    private boolean isVisibleLine ;

    public BigStateView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        init(context);
    }

    public BigStateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub

        TypedArray a = context.obtainStyledAttributes(attrs,R.styleable.BigStateView);
        isVisibleLine = a.getBoolean(R.styleable.BigStateView_visible_line,true);
        if(a.getString(R.styleable.BigStateView_text1_str) != null){
            text_1 = a.getString(R.styleable.BigStateView_text1_str);
        }
        if(a.getString(R.styleable.BigStateView_text2_str) != null){
            text_2 = a.getString(R.styleable.BigStateView_text2_str);
        }
        if(a.getString(R.styleable.BigStateView_text3_str) != null){
            text_3 = a.getString(R.styleable.BigStateView_text3_str);
        }

        init(context);
    }

    public BigStateView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        init(context);
    }
...
//        }).start();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bit2 = ((BitmapDrawable) getResources().getDrawable(
                R.mipmap.ic_circle_rule_big)).getBitmap();
...
//            canvas.drawText(standard.getMax() + unit, (float) (width * 2.0 / 3 - DrawUtil.getTextWidth(35, standard.getMax() + "") / 2), bit.getHeight() + bit2.getHeight() - 10, paint);
    ...
    public void setLanguage(String text1,String text2,String text3) {
        text_1 = text1;
        text_2 = text2;
        text_3 = text3;
    }
