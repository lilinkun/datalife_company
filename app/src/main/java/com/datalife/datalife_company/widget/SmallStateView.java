 ...
 */
public class SmallStateView extends View {
    ...
    public SmallStateView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
        init(context);
    }

    public SmallStateView(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        init(context);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bit2 = ((BitmapDrawable) getResources().getDrawable(
                R.mipmap.ic_circle_rule)).getBitmap();
        ...
        canvas.drawText(text_1, (float) (width * 1.0 / 6),
                bit.getHeight() + bit2.getHeight() + 40, textPain);
        canvas.drawText(text_2, (float) (width * 1.0 / 2),
                bit.getHeight() + bit2.getHeight() + 40, textPain);
        canvas.drawText(text_3, (float) (width * 5.0 / 6),
                bit.getHeight() + bit2.getHeight() + 40, textPain);
        if (standard != null) {
