 ...
 */
public class LX_LoadListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public LX_LoadListView(Context context, AttributeSet attrs, int defStyleAttr) {
