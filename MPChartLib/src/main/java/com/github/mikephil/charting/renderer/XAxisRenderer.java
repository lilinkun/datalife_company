...
public class XAxisRenderer extends AxisRenderer {
    ...
    protected void drawLabel(Canvas c, String formattedLabel, float x, float y, MPPointF anchor, float angleDegrees) {
        ...
        mFirstLinePaint.setTextSize(Utils.convertDpToPixel(12f));
        mFirstLinePaint.setTypeface(mXAxis.getTypeface());

        Paint mSecondLinePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mSecondLinePaint.setColor(0xF09b9b9b);
        mSecondLinePaint.setTextAlign(Align.CENTER);
        mSecondLinePaint.setTextSize(Utils.convertDpToPixel(12f));
